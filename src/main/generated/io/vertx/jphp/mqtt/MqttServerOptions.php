...
class MqttServerOptions extends NetServerOptions
{
  ...
  public function __construct($mqttServerOptions = null)
  {
   ...
   * @return bool
   */
  public function isAutoClientId()
  {
    return false;
  }

  /**
   * @param $autoClientId bool
   * @return $this
   */
  public function setAutoClientId($autoClientId)
  {
    return $this;
  }
  ...
  /**
   * @param $timeoutOnConnect integer
   * @return $this
   */
