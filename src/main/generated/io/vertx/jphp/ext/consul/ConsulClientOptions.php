...
use io\vertx\jphp\core\net\PfxOptions;
use io\vertx\jphp\core\net\ProxyOptions;
use io\vertx\jphp\ext\web\client\WebClientOptions;
...
class ConsulClientOptions extends WebClientOptions
{
  ...
  public function __construct($consulClientOptions = null)
  {
   ...
   * @return string
   */
  public function getAclToken()
  {
    return "";
  }

  /**
   * @param $aclToken string
   * @return $this
   */
  public function setAclToken($aclToken)
  {
    return $this;
  }
   ...
   * @return bool
   */
  public function isUserAgentEnabled()
  {
    return false;
  }

  /**
   * @param $userAgentEnabled bool
   * @return $this
   */
  public function setUserAgentEnabled($userAgentEnabled)
  {
    return $this;
  }
